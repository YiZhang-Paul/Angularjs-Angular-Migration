import IChannelRepository from '../repositories/IChannelRepository.interface';
import IGameRepository from '../repositories/IGameRepository.interface';
import IProviderRepository from '../repositories/IProviderRepository.interface';
